...
async function checkBackendReady(): Promise<{
  status: string;
}> {
  const wURL =
    ...
    return (
      <>
        ...
        <SEO
          ...
          description="Personal website containing thoughts, family history, memories, photographs and other interests."
        />
          ...
          >
            ...
            >
              ...
              <div className="mt-4 flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                {/* Information */}
                <div className="max-w-sm text-sm text-gray-600 leading-relaxed text-center md:text-left">
                  <p>
                    This site is for sharing content with my family and friends.
                  </p>
                  <p>
                    It is starting its backend service.
                    This may take a short while if the service has
                    been inactive.
                  </p>

                  <p className="mt-3">
                    The site will continue automatically as soon
